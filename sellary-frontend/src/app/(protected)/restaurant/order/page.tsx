    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                setProducts([
                    { id: 1, barcode: '1001', name: 'Плов', description: 'Традиционный узбекский плов', category_id: 1, product_type: 'dish', cost_price: '15000', sell_price: '35000', tax_percent: '0', stock_quantity: 100, min_stock_level: 10, is_active: true, created_at: '2024-01-01' },
                    { id: 2, barcode: '1002', name: 'Манты', description: 'Манты с мясом', category_id: 1, product_type: 'dish', cost_price: '10000', sell_price: '25000', tax_percent: '0', stock_quantity: 80, min_stock_level: 10, is_active: true, created_at: '2024-01-01' },
                    { id: 3, barcode: '1003', name: 'Шашлык', description: 'Шашлык из баранины', category_id: 3, product_type: 'dish', cost_price: '20000', sell_price: '45000', tax_percent: '0', stock_quantity: 50, min_stock_level: 5, is_active: true, created_at: '2024-01-01' },
                    { id: 4, barcode: '1004', name: 'Лагман', description: 'Узбекский лагман', category_id: 1, product_type: 'dish', cost_price: '8000', sell_price: '20000', tax_percent: '0', stock_quantity: 60, min_stock_level: 10, is_active: true, created_at: '2024-01-01' },
                    { id: 5, barcode: '1005', name: 'Самса', description: 'Самса с мясом', category_id: 5, product_type: 'dish', cost_price: '5000', sell_price: '12000', tax_percent: '0', stock_quantity: 100, min_stock_level: 20, is_active: true, created_at: '2024-01-01' },
                    { id: 6, barcode: '1006', name: 'Зелёный чай', description: 'Чайник зелёного чая', category_id: 6, product_type: 'dish', cost_price: '1000', sell_price: '5000', tax_percent: '0', stock_quantity: 200, min_stock_level: 50, is_active: true, created_at: '2024-01-01' },
                    { id: 7, barcode: '1007', name: 'Шурпа', description: 'Суп из говядины', category_id: 2, product_type: 'dish', cost_price: '8000', sell_price: '22000', tax_percent: '0', stock_quantity: 40, min_stock_level: 10, is_active: true, created_at: '2024-01-01' },
                    { id: 8, barcode: '1008', name: 'Нарын', description: 'Блюдо нарын', category_id: 1, product_type: 'dish', cost_price: '12000', sell_price: '30000', tax_percent: '0', stock_quantity: 30, min_stock_level: 10, is_active: true, created_at: '2024-01-01' },
                    { id: 9, barcode: '1009', name: 'Ачичук', description: 'Салат из свежих овощей', category_id: 4, product_type: 'dish', cost_price: '3000', sell_price: '10000', tax_percent: '0', stock_quantity: 50, min_stock_level: 10, is_active: true, created_at: '2024-01-01' },
                    { id: 10, barcode: '1010', name: 'Чёрный чай', description: 'Чайник чёрного чая', category_id: 6, product_type: 'dish', cost_price: '1000', sell_price: '5000', tax_percent: '0', stock_quantity: 200, min_stock_level: 50, is_active: true, created_at: '2024-01-01' },
                    { id: 11, barcode: '1011', name: 'Минералка', description: '0.5л минеральная вода', category_id: 6, product_type: 'dish', cost_price: '1500', sell_price: '5000', tax_percent: '0', stock_quantity: 100, min_stock_level: 20, is_active: true, created_at: '2024-01-01' },
                    { id: 12, barcode: '1012', name: 'Тандыр-нан', description: 'Горячий тандырный хлеб', category_id: 5, product_type: 'dish', cost_price: '2000', sell_price: '5000', tax_percent: '0', stock_quantity: 50, min_stock_level: 10, is_active: true, created_at: '2024-01-01' },
                ]);
            } finally {
                setIsLoading(false);
            }
